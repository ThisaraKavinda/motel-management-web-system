...
export default function F_M_SelectFood() {
  ...
  const viewOnClickHandler = async (
    name,
    image,
    category,
    regularPrice,
  ...
  const onDeleteItemCart = async (index) => {
    ...
    for (let i = 0; i < cartItems.length; i++) {
      if (i == index) {
        ...
        continue;
      } else newCartItem.push(cartItems[i]);
    }
            ...
            <div class="container-fluid">
                  ...
                  <div class="card-body mt-3 mb-2" style={{ margin: "0px" }}>
                    ...
                    <div class="row d-flex justify-content-between mb-4">
                      ...
                      <div class="col-2 mx-4 px-3">
                            ...
                            >
                              <div class="row" >
                                <div class="col-7 px-3 d-flex justify-content-end">
                                  <p class="text-light mb-0 fw-bold">
                                    {numCartItems} items
                                  </p>
                                </div>
                        ...
                        >
                          <div
                            class="border shadow px-4 py-3 bg-light"
                            style={{
                              width: "400px",
                              position: "absolute",
                              right: "1px",
                          ...
                          >
                            <div class="row d-flex justify-content-between align-items-center mb-2" >
                              ...
                              <div class="col-auto">
                                <h5 class="fw-semibold monospace fs-6">
                                  {numCartItems} items
                                </h5>
                              </div>
                            </div>
                              ...
                              {cartItems.map((value, index) => (
                                <div class="row d-flex justify-content-between align-items-center mb-2">
                                  ...
                                  <div class="col-6  align-items-center">
                                    <div class="row">
                                      <h5 class="fw-semibold monospace fs-6 mb-0">
                                        {value.item.name}
                                      </h5>
                                    </div>
                                    <div class="row">
                                      <p
                                        class=" monospace mb-0"
                                        style={{ fontSize: "13px" }}
                                      >
                                        Rs. {value.price}
                                      </p>
                                  ...
                                  <div class="col-2">
                                    <img
                                      src={bin}
                                      class="img-fluid mb-1 p-1"
                                      onClick={onDeleteItemCart.bind(
                                        this,
                                        index
                                      )}
                                      style={{ height: "40px" }}
              ...
              {categories.map((category, index) => (
                <FoodCategory
                  ...
                  viewOnClickHandler={viewOnClickHandler}
                />
              ))}
            </div>
