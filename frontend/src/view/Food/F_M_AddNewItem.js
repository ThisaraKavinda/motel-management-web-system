  ...
  async function addItem() {
    if (name === "" && type === "" && category === "") {
      ...
      isLarge
        ...
        : data.append("largePrice", "");
      isFamily
        ? data.append("familyPrice", familyPrice)
        : data.append("familyPrice", "");
      isSpecial
        ? data.append("specialPrice", specialPrice)
        : data.append("specialPrice", "");
                  ...
                  <div class="card-body mt-3 mb-2" style={{ margin: "0px" }}>
                    <div class="row mb-2 px-4">
                      <h5 class="fw-semibold">
                        Submit the following form to add a new item
                      </h5>
                    </div>
                    ...
                    {isOtherSizes ? (
                      <NewFoodPrices settingPrices={settingPrices} />
                    ) : (
                      <NewItemPrice settingPrices={settingPrices} />
                    )}
                    ...
                    <div class="row d-flex justify-content-center mb-2 mt-5">
                      <div class="col-5 d-flex justify-content-center">
                        <button
                          class="btn btn-primary w-75 mx-5 py-2 fw-semibold"
                          onClick={() => addItem()}
                        >
                          Add
                        </button>
                        <button
                          class="btn btn-primary w-75 mx-3 py-2 fw-semibold"
                          style={{
