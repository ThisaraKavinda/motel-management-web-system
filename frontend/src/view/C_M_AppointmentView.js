...
//css
import "./C_M_AppointmentView.css";
          ...
          if (willDelete) {
            updateRoomState({
              ...
              if (result.status) {
                ...
                updateAppointmentState({ _id: id, state: state }).then(
                  (result) => {
                    getAllPending().then((result) => {
                      setAppointmentList(result);
                    });
      ...
      <div class="main">
        <main class="content">
          <div class="container-fluid">
            <div class="header">
              <h1 class="header-title">View Appointments</h1>
              <br></br>
              <div
                              ...
                              {value.state === "Pending" ? (
                                <>
                                  ...
                                  <button
                                    ...
                                    style={{ marginLeft: 10, width: 60 }}
                                    onClick={() =>
                                      updateStatet(value._id, "Cancel")
                                    }
                                  >
                                    Cancel
                                  </button>
                                  <Link
                                    to={"/appointmentEdit/" + value._id}
                                    class="top-bar-link"
                                  >
                                    <button
